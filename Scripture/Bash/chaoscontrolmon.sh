...
#If no argument is supplied or the specified disk cannot be detected and the auto-detect mechanism fails, the script defaults to /dev/sda.
#=================================================================================================================================================
...
if [[ -z "$DEVICE" ]]; then
    ...
    #If no argument supplied and no disks are able to be auto-detected, default to /dev/sda:
    [[ -n "$DEVICE" ]] || DEVICE="/dev/sda"
fi
